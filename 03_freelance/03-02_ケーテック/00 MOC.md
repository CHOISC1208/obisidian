...
### 打ち合わせ記録
> [!info] 2026-09-22から、1回の打ち合わせに紐づくものは `50-打ち合わせ/<日付>/` にまとめる方針に変更
> （日付は打ち合わせ当日。09-22分は明日09-23の打ち合わせで使うため `50-打ち合わせ/2026-09-23/` に入れてある）。
> 過去分（08-07〜09-09）は直下に残したまま未移動。
...
- `50-打ち合わせ/2026-09-23/`（2026-09-23打ち合わせ用）
  - [[2026-09-23/2026-09-22 年休・慶弔・昼食の追加要望]] — 稼働後のフィードバック第2弾
  - [[2026-09-23/ver8リリース内容と2026-09-22回答のまとめ（打ち合わせ準備用）]] — **ver8で送った確認依頼と、その回答の対応**
...
### 2026-09-22 — `30-プラットフォーム/spo/` を新設し、打ち合わせノートの日付フォルダ運用を開始

2026-09-21の未整理事項のうち2点に着手した。

1. **`30-プラットフォーム/spo/` を新設し、バージョン記録を開始した。** `社内申請ポータル`
   （`20-案件/社内申請ポータル/`）を `20-案件/` か `30-プラットフォーム/` のどちらに置くかは
   まだ判断していないが（既存17ノートは今回動かしていない）、**新たに「リリースのたびに変化点を
   記録する」という運用**を `30-プラットフォーム/spo/ver8/` から開始した。ver7以前は遡って作らない。
   → [[30-プラットフォーム/spo/ver8/ver8 リスト別機能一覧（ベースライン）]]
2. **「1回の打ち合わせに紐づくものは `50-打ち合わせ/<日付>/`」のルールを実際に使い始めた。**
   2026-09-23の打ち合わせ向けに `50-打ち合わせ/2026-09-23/` を作り、当日（2026-09-22）受領した
   [[2026-09-23/2026-09-22 年休・慶弔・昼食の追加要望|要望ノート]]をそこへ移動し、
   ver8の確認依頼とのつながりをまとめた新規ノートも同じフォルダに追加した。
   **過去分（08-07〜09-09）は今回移動していない**（上の表の対象は未着手のまま）。
