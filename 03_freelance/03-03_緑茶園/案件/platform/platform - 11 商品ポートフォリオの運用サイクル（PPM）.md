...
**残作業（低優先度）**：「その他」351シリーズ・369本のうち、少なくとも「工房ゆずりは」（163本）は本来の品目（雑貨・陶器など）を先方に確認して登録し直す価値がある。急ぎではない。
...
**これで PPM の運用サイクルの土台（分類・遷移の追跡・ダッシュボードとの統合）が一通りそろった。** 次の一歩は、主力シリーズを四半期または年1回の頻度で見直す運用に乗せること（[[08 要確認事項]] の「四半期の見直し体制」）。
