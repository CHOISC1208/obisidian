...
親: [[easyECS - 00 概要]] ／ 関連: [[easyECS - 02 DB構造（ecsdb_esy）]] ／ [[platform - 10 変換器構想とMDC出力]]
...
> 〔CSV の「ストア名」がこの `m_name.store_cd` の表示名そのものかは未照合。確定するまで 9/8 の判断は暫定扱い〕→ [[platform - 10 変換器構想とMDC出力]]
