...
親: [[easyECS - 00 概要]] ／ 関連: [[easyECS - 02 DB構造（ecsdb_esy）]] ／ [[EC Channel Console - 変換器構想とMDC出力]]
...
> 〔CSV の「ストア名」がこの `m_name.store_cd` の表示名そのものかは未照合。確定するまで 9/8 の判断は暫定扱い〕→ [[EC Channel Console - 変換器構想とMDC出力]]
...
- [[EC Channel Console - 変換器構想とMDC出力]] — 受注CSVの解析結果（2026-09-08）
